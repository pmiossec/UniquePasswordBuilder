(function(upb) {
    ...
    form.setAttribute(
        'style',
        'position:absolute;top:10px;right:10px;border:1px solid black;padding:10px 10px 8px 10px;background-color:white;font-size:12px;z-index:10000000;'
    );
    //Salt
    ...
    var passwordEntered = function(e) {
        ...
        upb.generate(
            algorithm,
            locationSalt,
            window.uniquePasswordBuilderDifficulty || window.uniquePasswordBuilderRounds,
            passwordInput.value,
            saltInput.value,
